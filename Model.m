...
load BAnetOn1000.mat *N *A *AA
mat=AA;
%初始化个体异质性特征:个体从众性
Person=zeros(N,1);
alfa1=normrnd(0.5,0.15,[N,1]);
alfa1(alfa1>1)=1;
alfa1(alfa1<0)=0;
Person(:,1)=alfa1(:,1);%个体异质性：个体从众性
period=100;
Type=zeros(N,period);
...
load ori_information.mat *Infor_wuzizheng *Infor_wuzifu *Infor_anquanzheng *Infor_anquanfu
